...
A checkout page to place the order for the items in cart and provide address details.
An Order Tracking page to track the status of orders placed by user by order id.
